...
var CompCharts = function() {
    ...
    return {
        init: function() {
            ...
            var chartClicks  = $('#click-chart');
            var chartSales = $('#sales-chart');
            ...
            chartClicks.bind('plothover', function(event, pos, item) {
            ...
            // Creating and attaching a tooltip to the classic chart
            var previousPoint = null, ttlabel = null;
            chartSales.bind('plothover', function(event, pos, item) {
