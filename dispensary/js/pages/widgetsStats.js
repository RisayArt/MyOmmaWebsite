...
var WidgetsStats = function() {
    ...
    return {
        init: function() {
            ...
            var dataNew = [[1, 50], [2, 42], [3, 48], [4, 50], [5, 60], [6, 85], [7, 110], [8, 95], [9, 122], [10, 130], [11, 150], [12, 170]];
                ...
                [
                    {
                        ...
                        points: {show: true, radius: 6, fillColor: '#46b7bf '}
                    },
                    {
                        data: dataNew,
                        lines: {show: true, fill: false},
                        points: {show: true, radius: 6, fillColor: '#888888 '}
                    },
                    {
                        data: dataSales,
                        lines: {show: true, fill: false},
            ...
            $.plot(chartWidget2,
                [
                    ...
                    },
                    {
                        data: dataNew,
                        lines: {show: true, fill: false},
                        points: {show: true, radius: 6, fillColor: '#27ae60 '}
                    },
                    {
                        data: dataSales,
                        lines: {show: true, fill: false},
